...
**Version:** 1.1.22 — *Backfill William (T&M Care) FormSubmit note into shared ticker*

There are **two** Hugging Face Spaces (same static build). The first attempt (`careTalk`) briefly used a HF build step that needs paid credits and stuck on **CONFIG_ERROR**; `careTalk-demo` is the clean prebuilt Space. From **v1.1.9** both host the identical release (current: **v1.1.22**).
...
### Shared feedback ticker (v1.1.22)
