...
**Version:** 1.1.29 — *Backfill Mary Nsaidoo-Storph + William FormSubmit notes*

There are **two** Hugging Face Spaces (same static build). The first attempt (`careTalk`) briefly used a HF build step that needs paid credits and stuck on **CONFIG_ERROR**; `careTalk-demo` is the clean prebuilt Space. From **v1.1.9** both host the identical release (current: **v1.1.29**).
...
### Shared feedback ticker (v1.1.29)
